...
namespace BackendAndAPI.Controllers.Users
{
    ...
    public class UsersViewController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Height,Weight,Group")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Height,Weight,Group")] User user)
        {
            if (id != user.Id)
            {
                return NotFound();
